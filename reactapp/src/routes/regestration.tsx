...
export const Route = createFileRoute("/regestration")({
...
function RouteComponent() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const newuser = await auth.regester({
      ...
      <Form {...form}>
        ...
        >
          <div className="h-screen ">
            <Label className="h-1/4 text-3xl w-full justify-center text-white">
          ...
          >
            {isLoggingIn ? "Завантаження..." : "Зареєструватися"}
          </Button>
        </form>
      </Form>
    </div>
